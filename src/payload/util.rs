...
///
/// ```test(pad_size)
/// assert_eq!(super::pad_size(4), 0);
/// assert_eq!(super::pad_size(0), 0);
/// assert_eq!(super::pad_size(5), 3);
/// ```
#[inline(always)]
...
/// ```test(long_key)
/// let buffer = [
///     0x3eu8, 0x2f, 0x79, 0x1e, 
///     0x1f, 0x14, 0xd1, 0x73, 
///     0xfc, 0x91, 0xff, 0x2f,
///     0x59, 0xb5, 0x0f, 0xd1
/// ];
///
/// let key = super::long_key("panda", "panda", "raspberry");
...
/// ];
/// 
/// let hmac_output = super::hmac_sha1(&key, vec![&buffer]).unwrap().into_bytes();
...
///
/// ```test(crc32)
/// assert_eq!(super::fingerprint(b"1"), 3498621689);
/// ```
...
///
/// ```test(as_u16)
/// let int = super::as_u16(&[0x00, 0x04]);
/// assert_eq!(int, 4);
/// ```
#[inline(always)]
...
///
/// ```test(as_u32)
/// let int = super::as_u32(&[0x00, 0x00, 0x00, 0x04]);
/// assert_eq!(int, 4);
/// ```
#[inline(always)]
