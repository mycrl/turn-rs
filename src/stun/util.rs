...
///
/// ```
/// assert_eq!(turn_server::stun::util::pad_size(4), 0);
/// assert_eq!(turn_server::stun::util::pad_size(0), 0);
/// assert_eq!(turn_server::stun::util::pad_size(5), 3);
/// ```
#[inline(always)]
...
/// ];
///
/// let key = turn_server::stun::util::long_term_credential_digest(
///     "panda",
///     "panda",
///     "raspberry",
/// );
...
/// ];
///
/// let hmac_output = turn_server::stun::util::hmac_sha1(&key, &[&buffer])
///     .unwrap()
///     .into_bytes();
...
///
/// ```
/// assert_eq!(turn_server::stun::util::fingerprint(b"1"), 3498621689);
/// ```
