...
/// ];
/// 
/// let source: IpAddr = "192.168.0.107"
///     .parse()
///     .unwrap();
/// 
...
/// ];
/// 
/// let source: IpAddr = "::ffff:192.10.47.15"
///     .parse()
///     .unwrap();
/// 
...
///
/// let source: SocketAddr = "192.168.0.107:1"
///     .parse()
///     .unwrap();
///
/// let res: SocketAddr = "225.186.164.41:8467"
///     .parse()
///     .unwrap();
/// 
/// let token: [u8; 12] = [
...
///
/// let source: Ipv4Addr = "192.168.0.107"
///     .parse()
///     .unwrap();
///
/// let xor: IpAddr = "225.186.164.41"
///     .parse()
///     .unwrap();
/// 
...
///
/// let source: Ipv6Addr = "::ffff:192.10.47.15"
///     .parse()
///     .unwrap();
///
/// let xor: IpAddr = "2112:a442:6c46:6254:754b:bbae:8642:637e"
///     .parse()
///     .unwrap();
/// 
/// let token: [u8; 12] = [
