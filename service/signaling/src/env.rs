...
pub struct Environment {
    ...
    #[clap(long)]
    #[clap(env = "SIGAALING_LISTENING")]
    #[clap(default_value = "127.0.0.1:80")]
    ...
    #[clap(long)]
    #[clap(env = "SIGAALING_MAX_SEND_QUEUE")]
    ...
    #[clap(long)]
    #[clap(env = "SIGAALING_MAX_MESSAGE_SIZE")]
    ...
    #[clap(long)]
    #[clap(env = "SIGAALING_MAX_FRAME_SIZE")]
    ...
    #[clap(long)]
    #[clap(env = "SIGAALING_UNMASKED_FRAMES")]
